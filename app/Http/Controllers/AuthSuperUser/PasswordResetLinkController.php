...
class PasswordResetLinkController extends Controller
{
    ...
    {
        return view('authsuperuser.forgot-password');
    }
    ...
    public function verifyEmail($token, $email)
    {
        try {
            ...
            if ($tokenExists && $tokenExists->deleted_at) {
    ...
    public function createResetForm(Request $request)
    {
        ...
        return view('authsuperuser.reset-password', $data);
    }
    ...
    public function storeResetForm(Request $request)
    {
        ...
        try {
            ...
            PublicUser::where('email', $email)->update($updateData);
