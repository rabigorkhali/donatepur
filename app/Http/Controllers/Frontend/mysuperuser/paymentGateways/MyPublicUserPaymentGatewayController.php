...
namespace App\Http\Controllers\Frontend\mysuperuser\paymentGateways;
...
class MyPublicUserPaymentGatewayController extends Controller
{
    ...
    {
        return view('frontendsuperuser.my.payment-gateways.' . $viewFile, $data)->render();
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('frontend.my.superuser.payment-gateways.add', $data);
    }
