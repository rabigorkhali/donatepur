...
namespace App\Http\Controllers\Frontend\mysuperuser\donations;
...
class MyDonationReceivedController extends Controller
{
    use ImageTrait;
    ...
    public $url = "my/donations-received";
    public $pageTitle = "Donations Received";
    ...
    {
        return view('frontendsuperuser.my.donations.received.' . $viewFile, $data)->render();
    }
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            foreach ($thisAllData as $thisAllDataKey => $thisAllDataDatum) {
                $btnDetails = '<a target="_blank" href="' . route('my.donations.received.view', $thisAllDataDatum->id) . '" class="btn btn-xs btn-default text-teal mx-1 shadow" title="Details">
    ...
    public function view(Request $request, $thisModelId)
    {
        ...
        return view('frontend.my.superuser.donations.received.view', $data);
    }
}
