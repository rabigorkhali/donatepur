...
@section('auth_body')
    <form action="{{ $register_url }}" method="post">
        ...
        <div class="input-group mb-3">
            <label class="input-group mb-1">I agree to the privacy policy,terms and conditions and privacy policy of this website.</label>
            <input required="" type="checkbox" name="agree_term_and_condition" class="form-control">
