    ...
    <div class="lockscreen-wrapper">
        ...
        <div class="lockscreen-logo">
            <a href="{{ $dashboard_url }}">
                ...
                {!! config('adminlte.logo', '<b>Donatepur</b>') !!}
            </a>
        </div>

        {{-- Lockscreen user name --}}
        <div class="lockscreen-name">
            {{ isset(Auth::guard('frontend_users')->user()->name) ? Auth::guard('frontend_users')->user()->name : Auth::guard('frontend_users')->user()->email }}
        </div>
        ...
        <div class="lockscreen-item">
            @if(config('adminlte.usermenu_image'))
                <div class="lockscreen-image">
                    <img src="{{ Auth::guard('frontend_users')->user()->adminlte_image() }}" alt="{{ Auth::guard('frontend_users')->user()->name }}">
                </div>
            @endif
