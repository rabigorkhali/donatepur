                ...
                <div class="container">
                    <div class="row">
                        <div class="col col-xs-12 slide-caption">
                            ...
                            <p>Help us to eradicate poverty around the world and save the million of lives from unwanted
                    ...
                    <div class="col col-md-4 col-xs-6">
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{asset('uploads').'/'.imageName($topCausesDatum->cover_image,'-cropped')}}" alt="" class="img img-responsive">
                                {{-- <img src="{{asset('uploads').'/'.$topCausesDatum->cover_image}}" alt="" class="img img-responsive"> --}}
                            </div>
                            <div class="goal-raised">
                                <div class="progress">
                                    <div class="progress-bar progress-bar-s2 " data-percent="{{calculatePercentageMaxTo100($topCausesDatum->total_collection,$topCausesDatum->goal_amount)}}"></div>
                                </div>
                            ...
                            <div class="causes-title">
                                <h3><a href="#">{{$topCausesDatum->title}}</a></h3>
                            ...
                            <div class="cause-details-wrapper">
                                ...
                                <div class="causes-details">
                                    <p>Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
                                        magna aliqua. Ut enim ad minim veniam, quis nostrud exercita tion ullamco laboris.
                                    </p>
                                    <div class="donation">
                                        <h4>Donation</h4>
                                        <div class="progress">
