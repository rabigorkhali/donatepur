...
<div class="main-error-page">
                ...
                <g class="full-torradeira">
                    ...
                    <g class="pao-frente">
                        ...
                        <g transform="translate(-448 -158) translate(448 157) translate(350.495 206.834)">
                            ...
                            <path class="boca" fill="#633"
                                d="M-3.14 -7.546L17.993 -3.438 14.8 12.985 -6.333 8.878z" mask="url(#prefix__D)" />
                        </g>
                    </g>
                    <g class="torradeira"
    ...
    <h2 class="error-subtitle">
       <a href="{{url('/')}}"> CLICK HERE! GO TO HOMEPAGE</a>
    </h2>
</div>
