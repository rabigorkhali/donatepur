...
@section('content')
    <form method="put" action="{{ route('my.campaigns.update', $campaignDetail->id) }}" class="mt-6 space-y-6"
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <x-adminlte-input required name="{{ $formInputName }}" label={{}}
                    value="{{ old($formInputName, $campaignDetail->$formInputName) }}"
            ...
            <div class="col-md-6">
                ...
                <x-adminlte-select2 required name="{{ $formInputName }}"
                    ...
                    @foreach ($campaignCategories as $campaignCategoriesDatum)
                        <option value="nepal" @if ($campaignDetail->$formInputName == $campaignCategoriesDatum->title) selected @endif>
            ...
            <div class="col-md-12">
                ...
                <x-adminlte-text-editor required rows="20" label-class="" :row=30 name="{{ $formInputName }}" value="">
