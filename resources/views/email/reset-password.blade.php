                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img alt="Company Logo"
                                                                        src="{{asset('/static-images/donatepur_logo.png')}}"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img
                                                                        ...
                                                                        src="{{asset('/static-images/emails/round_corner_top.png')}}"
                                                            ...
                                                            <td class="pad">
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img
                                                                        ...
                                                                        src="{{asset('/static-images/emails/reset.png')}}"
                                                                        style="display: block; height: auto; border: 0; width: 170px; max-width: 100%;"
                                                                    ...
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:14px;">If you have
                                                                                not requested a password change, please
                                                                                report it to
                                                                                support@donatepur.com.</span></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img
                                                                        ...
                                                                        src="{{asset('/static-images/emails/round_corner_bottom.png')}}"
                                                                        style="display: block; height: auto; border: 0; width: 680px; max-width: 100%;"
